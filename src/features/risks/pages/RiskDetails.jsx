...
import { useRisk } from "@/features/risks/hooks/useRisk"
import { useRole } from "@/features/auth/hooks/useRole"
import { useRiskResponses } from "@/features/risks/hooks/useRiskResponses"
import { updateRisk, deleteRisk } from "@/features/risks/api/riskApi"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
          ...
          <div className="space-y-6">
            <Section eyebrow="Description">
              <p className="text-sm text-foreground/90 leading-relaxed">
                {risk.risk_description || <span className="italic text-muted-foreground">No description provided</span>}
              </p>
            </Section>
          </div>
